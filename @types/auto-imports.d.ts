...
declare global {
  ...
  const effectScope: (typeof import('vue'))['effectScope']
  const faviconLoader: (typeof import('../src/tools/faviconLoader'))['faviconLoader']
  ...
  const naiveUILoader: (typeof import('../src/tools/naiveUILoader'))['naiveUILoader']
  ...
  const useCounterStore: (typeof import('../src/store/counter/index'))['useCounterStore']
  ...
  const useThemeStore: (typeof import('../src/store/theme/index'))['useThemeStore']
